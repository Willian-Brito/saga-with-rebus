...
public class PedidoSaga : Saga<PedidoSagaData>,
        IAmInitiatedBy<IniciarPedidoCommand>,
...

{
    ...
    {
        config.Correlate<IniciarPedidoCommand>(m => m.AggregateRoot, d => d.Id);
    ...
    public Task Handle(IniciarPedidoCommand message)
    {
        //_bus.Send(new IniciarPedidoCommand{AggregateRoot = message.AggregateRoot}).Wait();
